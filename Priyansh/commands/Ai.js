...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "taha khan",
    description: "Chat with ladli AI",
    commandCategory: "ai",
    usages: "[message]",
    cooldowns: 5,
};
...
const GROQ_API_KEY = "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";

// 👆👆👆 --------------------------- 👆👆👆

const HISTORY_FILE = path.join(__dirname, "temporary", "ladli_oye_history.json");
const HISTORY_LIMIT = 10;
const MODEL_NAME = "llama-3.3-70b-versatile"; 

// --- CHARACTER PROMPT (Sweet + Roast) ---
const SYSTEM_PROMPT = `Tumhara naam ladli hai (log tumhe taha bhi bulate hain).
